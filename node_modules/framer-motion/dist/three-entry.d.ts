 ...
 * @public
 */
declare type InertiaOptions$1 = Partial<Omit<Inertia, "velocity" | "type">>;
/**
 * @public
 */
interface DraggableProps extends DragHandlers {
     ...
     * ```
     */
    dragTransition?: InertiaOptions$1;
    /**
...
declare type OnKeyframesResolved<T extends string | number> = (resolvedKeyframes: ResolvedKeyframes<T>) => void;
...
export { AnimationType, MotionContext, ResolvedValues, ScrapeMotionValuesFromProps, VisualState, addPointerEvent, addPointerInfo, animations, calcLength, createBox, filterProps, isBrowser, isDragActive, isMotionValue, makeUseVisualState, useForceUpdate, useIsomorphicLayoutEffect, useUnmountEffect };
